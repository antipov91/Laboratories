...
public partial class MetaEntity
{
	...
	/// </summary>
	public void CopyTo(MetaEntity copyToEntity)
	{
		for (var i = 0; i < MetaComponentsLookup.TotalComponents; ++i)
		{
			if (HasComponent(i))
			{
				if (copyToEntity.HasComponent(i))
				{
					throw new EntityAlreadyHasComponentException(
						...
						MetaComponentsLookup.ComponentNames[i] +
						"' to " +
						this +
						"!",
	...
	/// </summary>
	public void CopyTo(MetaEntity copyToEntity, bool replaceExisting)
	{
		for (var i = 0; i < MetaComponentsLookup.TotalComponents; ++i)
		{
			if (!HasComponent(i))
	...
	/// <summary>
	/// Copies components on this entity at <paramref name="indices"/> in the <see cref="MetaComponentsLookup"/> to
	...
	/// </summary>
	public void CopyTo(MetaEntity copyToEntity, bool replaceExisting, params int[] indices)
	{
		for (var i = 0; i < indices.Length; ++i)
		{
			...
			if (index < 0 && index >= MetaComponentsLookup.TotalComponents)
			{
				...
				throw new IndexOutOfLookupRangeException(
					string.Format(OUT_OF_RANGE_WARNING, index, nameof(MetaComponentsLookup)),
					HINT);
			}
