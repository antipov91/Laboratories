...
/// <see cref="MetaEntity"/>.
/// </summary>
[CreateAssetMenu(fileName = "NewMetaBlueprint", menuName = "EntitasRedux/Meta/MetaBlueprint")]
public partial class MetaBlueprint : BlueprintBase, IMetaBlueprint
{
	/// <summary>
	/// Applies all components in the blueprint to <paramref name="entity"/>.
	/// </summary>
	/// <param name="entity"></param>
	public void ApplyToEntity(MetaEntity entity)
	{
		for (var i = 0; i < _components.Count; i++)
		{
			...
			var index = MetaComponentsLookup.GetComponentIndex(component);
			if (index != -1)
			{
	...
	protected override void OnValidate()
	{
		...
		{
			var index = MetaComponentsLookup.GetComponentIndex(_components[i]);
			if (index == -1)
			{
