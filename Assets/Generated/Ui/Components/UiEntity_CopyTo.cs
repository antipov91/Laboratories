...
public partial class UiEntity
{
	...
	public void CopyComponentTo(IComponent component)
	{
		...
		else if (component is Laboratories.Components.Ui.ManagerComponent Manager)
		{
			IsManager = true;
		}
	...
	/// </summary>
	public void CopyTo(UiEntity copyToEntity)
	{
		for (var i = 0; i < UiComponentsLookup.TotalComponents; ++i)
		{
			if (HasComponent(i))
			{
				if (copyToEntity.HasComponent(i))
				{
					throw new EntityAlreadyHasComponentException(
						...
						UiComponentsLookup.ComponentNames[i] +
						"' to " +
						this +
						"!",
	...
	/// </summary>
	public void CopyTo(UiEntity copyToEntity, bool replaceExisting)
	{
		for (var i = 0; i < UiComponentsLookup.TotalComponents; ++i)
		{
			if (!HasComponent(i))
	...
	/// <summary>
	/// Copies components on this entity at <paramref name="indices"/> in the <see cref="UiComponentsLookup"/> to
	...
	/// </summary>
	public void CopyTo(UiEntity copyToEntity, bool replaceExisting, params int[] indices)
	{
		for (var i = 0; i < indices.Length; ++i)
		{
			...
			if (index < 0 && index >= UiComponentsLookup.TotalComponents)
			{
				...
				throw new IndexOutOfLookupRangeException(
					string.Format(OUT_OF_RANGE_WARNING, index, nameof(UiComponentsLookup)),
					HINT);
			}
